#ifndef RAGE_OF_MAGES_1_256_H_
#define RAGE_OF_MAGES_1_256_H_
...
class rage_of_mages_1_256_t : public kaitai::kstruct {

public:
    class sprite_record_t;

    rage_of_mages_1_256_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, rage_of_mages_1_256_t* p__root = 0);

private:
    void _read();

public:
    ~rage_of_mages_1_256_t();

    class sprite_record_t : public kaitai::kstruct {

    public:

        sprite_record_t(kaitai::kstream* p__io, rage_of_mages_1_256_t* p__parent = 0, rage_of_mages_1_256_t* p__root = 0);
    ...
    private:
        ...
        std::string m_data;
        rage_of_mages_1_256_t* m__root;
        rage_of_mages_1_256_t* m__parent;
    ...
    public:
        ...
        rage_of_mages_1_256_t* _root() const { return m__root; }
        rage_of_mages_1_256_t* _parent() const { return m__parent; }
    };
